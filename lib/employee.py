...
class Employee:
    ...
    def __init__(self, name, job_title, department_id, id=None): #add department_id(foreign key)
        self.id = id
        self.name = name
        self.job_title = job_title
        self.department_id = department_id #Add

    def __repr__(self):
        return (
            f"<Employee {self.id}: {self.name}, {self.job_title}>"
            f":<Department ID: {self.department_id}>" #Add
        )
    ...
    def save(self):
        ...
        CURSOR.execute(sql, (self.name, self.job_title, self.department_id))#Added here and select query above
        CONN.commit()
    ...
    def update(self):
        ...
        sql = """
            ...
            WHERE id = ?
        """
        CURSOR.execute(sql, (self.name, self.job_title, self.department_id, self.id)) #added here and query above
        CONN.commit()
    ...
    @classmethod
    def create(cls, name, job_title, department_id): #added
        """ Initialize a new Employee instance and save the object to the database """
        employee = cls(name, job_title, department_id) #added
        employee.save()
        return employee
